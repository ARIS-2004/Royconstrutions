              ...
              {[
                {
                  ...
                  content: (
                    <div className="flex flex-col gap-1">
                      <a href="tel:+918981040466" className="text-[12.5px] text-white/70 hover:text-[#B8965A] transition-colors duration-200 leading-[1.75]" style={{ fontFamily: 'var(--font-body)' }}>+91 89810 40466</a>
                      <a href="https://wa.me/918981040466" target="_blank" rel="noopener noreferrer" className="text-[10.5px] text-[#B8965A]/60 hover:text-[#B8965A] transition-colors duration-200" style={{ fontFamily: 'var(--font-body)' }}>Open in WhatsApp →</a>
                    </div>
                  ),
                },
                {
                  ...
                  label: 'Email',
                  content: (
                    <a href="mailto:info@rcepl.com" className="text-[12.5px] text-white/70 hover:text-[#B8965A] transition-colors duration-200 leading-[1.75]" style={{ fontFamily: 'var(--font-body)' }}>info@rcepl.com</a>
                  ),
                },
                {
                  icon: MapPin,
                  label: 'Head Office',
                  content: (
                    <p className="text-[12.5px] text-white/70 leading-[1.75]" style={{ fontFamily: 'var(--font-body)' }}>
                      Room No-5, Unit No-3WS1, 3rd Floor,<br />
                      Mani Casadona, Newtown Square,<br />
                      Kolkata, West Bengal
                    </p>
                  ),
                },
                {
                  ...
                  label: 'Working Hours',
                  content: (
                    <p className="text-[12.5px] text-white/70 leading-[1.75]" style={{ fontFamily: 'var(--font-body)' }}>Mon – Sat, 9am – 6pm</p>
                  ),
                },
              ].map((item, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div>
                      <p className="text-[8.5px] tracking-[0.35em] uppercase text-white/30 mb-1.5" style={{ fontFamily: 'var(--font-body)' }}>
                        {item.label}
                      </p>
                      {item.content}
                    </div>
        ...
        >
          <form onSubmit={handleSubmit} className="w-full max-w-lg">
            ...
            <div className="mb-10">
              ...
              <h3 className="text-[30px] text-[#1A1A1A] leading-tight" style={{ fontFamily: 'var(--font-heading)', fontWeight: 400 }}>
                Send Us a Message
              </h3>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                {[
                  ...
                  <div key={field.name}>
                    <label className="block text-[9px] tracking-[0.35em] uppercase text-[#1A1A1A]/40 mb-2.5" style={{ fontFamily: 'var(--font-body)' }}>
                      {field.label}
                    </label>
                    <input
                      type={field.type}
              ...
              <div>
                <label className="block text-[9px] tracking-[0.35em] uppercase text-[#1A1A1A]/40 mb-2.5" style={{ fontFamily: 'var(--font-body)' }}>
                  Phone <span className="normal-case tracking-normal text-[#1A1A1A]/22">(Optional)</span>
                </label>
                <input
                  type="tel"
                  name="phone"
            ...
            {status === 'success' && (
              <div className="flex items-center gap-3 mt-6 px-4 py-3 bg-[#B8965A]/6 border-l-2 border-[#B8965A]">
                ...
                <p className="text-[#B8965A] text-[12px]" style={{ fontFamily: 'var(--font-body)' }}>Thank you! We'll be in touch shortly.</p>
              </div>
            )}
            {status === 'error' && (
              <div className="flex items-center gap-3 mt-6 px-4 py-3 bg-red-50 border-l-2 border-red-400">
                <p className="text-red-500 text-[12px]" style={{ fontFamily: 'var(--font-body)' }}>Something went wrong. Please try again.</p>
              </div>
            )}
            ...
            >
              ...
              {status !== 'sending' && <ArrowRight size={11} className="group-hover:translate-x-0.5 transition-transform duration-300" />}
            </button>

            {/* Trust */}
            <div className="flex items-center gap-3 mt-5">
              <div className="flex-1 h-px bg-[#1A1A1A]/6" />
              <p className="text-[10px] text-[#1A1A1A]/28 whitespace-nowrap" style={{ fontFamily: 'var(--font-body)' }}>
